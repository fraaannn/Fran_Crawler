...
function getRequestURL(account, pwd, smscode) {
    var f = "6C57AB91A1308E26B797F4CD382AC79D";
    var b = new Date();
    var m = b.getFullYear();
    var v = b.getMonth() + 1;
    var r = b.getDate();
    ...
    var n = b.getSeconds();
    var j = m + "-" + v + "-" + r + "" + " " + s + ":" + p + ":" + n;
    var k = "ddsy.user.reg.regusermethodddsy.user.reg.reguserpassword" + md5(pwd) + "platH5platformH5smsCode" + smscode + "t" + j + "userName" + account + "v1.0versionName3.5.0" + f;
    var w = md5(k);
    return w
}
